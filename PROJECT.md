...
**Addendum, 2026-09-13, from a real data/code deep-dive (see `noxos-app/ML-NETWORK-DESIGN.md` for full reasoning) — three decisions, two now built:**
